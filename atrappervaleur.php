...
<body>
    ...
    try {
        ...
        $sortir = verifsortie($creneau, $resultat,$regime);
        ...
        echo "<div><h2>Mati&egrave;re courante : " . $resultat[0][$creneau] . " </h2></div>";
        echo "</div>";

        //Affiche l'edt du jour courant de l'eleve
        //$jourcourant=trim($creneau,"MS1234");
        echo "<div class='edtjour'>";
        //echo $jourcourant."</br></br>";
        //$pascours=0;
        // foreach($resultat[0] as $clef => $valeur){
        //     if(trim($creneau,"MS1234")==trim($clef,"MS1234")){
        //     echo trim($clef,"ABCDEFG"). ' : ' .$valeur. '<br>';
        //         if($valeur=='pas cours'){
        //             $pascours=$pascours+1;
        //         } else {
        //             $pascours=0;
    ...
    function premiercours($creneau = 'DM3', $resultat = [''])
    {
        $rep = 'salut';
        if (ltrim($creneau, "ABCDE") == 'M0') {
            $c = trim($creneau, "MS01234");
            foreach ($resultat as $matiere => $valeur) {
    ...
    function verifsortie($creneau = 'DM3', $resultat = [''],$regime=[''])
    {
        $pascoursM = 0;
        $pascoursS = 0;
        // $premcours='';
        ...
        $p = 0;
        foreach ($resultat as $matiere => $valeur) {//changement[0]
        ...
        switch ($horshoraire) {
            ...
            case 'M0':
                ...
                $retour[4] = premiercours($creneau, $resultat);
                break;
            case 'F';
